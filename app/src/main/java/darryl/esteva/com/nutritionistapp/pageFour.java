...
public class pageFour extends AppCompatActivity {
    ...
    DatabaseHelper myDb;
    EditText editName, editUsername, editBmi, editTextId;
    Button btnAddData;
    Button btnviewAll;
        ...
        btnDelete.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(deletedRows > 0){
                            Toast.makeText(pageFour.this, "Data Deleted", Toast.LENGTH_LONG).show();
                        }

                        else
                        {
                            Toast.makeText(pageFour.this, "Data not Deleted", Toast.LENGTH_LONG).show();
                        }
                    }
                }
        ...
        btnviewUpdate.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v)
                    {
                        ...
                        if(isUpdate == true)
                        {
                            Toast.makeText(pageFour.this, "Data Updated", Toast.LENGTH_LONG).show();
                        }

                        else
                        {
                            Toast.makeText(pageFour.this, "Data not Updated", Toast.LENGTH_LONG).show();
                        }
                ...
                new View.OnClickListener(){
                    ...
                    public void onClick(View v)
                    {
                        boolean isInserted = myDb.insertData(
                                ...
                                editBmi.getText().toString()

                        );

                        if(isInserted == true)
                        {
                            Toast.makeText(pageFour.this, "Data Inserted", Toast.LENGTH_LONG).show();
                        }

                        else
                        {
                            Toast.makeText(pageFour.this, "Data not Inserted", Toast.LENGTH_LONG).show();
                        }
